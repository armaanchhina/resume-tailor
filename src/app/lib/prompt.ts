export const tailorResumePrompt = (resumeJson: any, jobDescription: string) => `
    ...
    - Do NOT include literal "\\n" in JSON. Instead, insert real line breaks within string values.
...
export const dummyData = {
    "summary": "Software developer with experience building backend services in Python, TypeScript, and cloud-native systems. Strong focus on clean design, readable code, and product-focused engineering. Skilled in debugging, performance optimization, and collaborating across product and infrastructure teams.",
    "workExperience": [
      {
